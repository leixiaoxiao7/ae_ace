"""
train the system on normaly data --> anything out of that normality is abnormal
...
# Convert the string labels to numeric codes before building masks.
df["Quality"] = df["Quality"].map({"Good": 1, "Bad": 2})
